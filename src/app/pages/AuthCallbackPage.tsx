 ...
 * 3. Backend redirects user to GitHub for authentication
 * 4. GitHub redirects back to backend's /api/auth/github/callback?code=...&state=...
 * 5. Backend exchanges code for token, sets session cookie
 * 6. Backend redirects back to frontend at /auth/callback
 * 7. Frontend fetches current user to confirm authentication
...
export function AuthCallbackPage() {
  ...
  // Fetch current user (backend has already set session cookie)
  ...
  // Store user in Redux and redirect on successful fetch
  useEffect(() => {
  ...
  // Handle fetch errors (not authenticated)
  useEffect(() => {
